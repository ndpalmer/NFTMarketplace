...
const ButtonGroup = ({ setActive, router, setIsOpen }) => {
  ...
  return currentAccount ? (
    ...
    <Button
      btnName="Connect"
      classStyles="mx-2 rounded-xl text-white"
...
const Navbar = () => {
  ...
  return (
    <nav className="flexBetween w-full fixed z-10 p-4 flex-row border-b dark:bg-nft-black-2 bg-white dark:border-nft-black-1 border-nft-gray-1">
      <div className="flex flex-1 flex-row justify-start">
        <Link href="/">
          ...
          >
            ...
            <p className="dark:text-white text-nft-black-1 font-semibold text-lg ml-1">NftySea</p>
          </div>
        </Link>
        <Link href="/">
          <div
      ...
      <div className="flex flex-initial flex-row justify-end">
        <div className="flex items-center mr-2">
          ...
          <label htmlFor="checkbox" className="flexBetween w-8 h-4 bg-black rounded-2xl p-1 relative label">
            ...
            <div className="w-3 h-3 absolute bg-white rounded-2xl ball" />
          </label>
        </div>
      </div>
